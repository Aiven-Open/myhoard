        ...
        with self._handle_request(name="backup_create"):
            ...
            with self.controller.lock:
                if backup_type == self.BackupType.basebackup:
                    ...
                    # Callers compare this against latest_processed_binlog_index in /status to learn when it is durable
            ...
            return json_response(
                {
                    ...
                    "latest_processed_binlog_index": self.controller.get_latest_processed_binlog_index(),
                }
            )
